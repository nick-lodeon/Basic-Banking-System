...
<head>
	...
	body
	{
		...
		body{
		background-image:url("images/bgbank4.jpg");
...
<body >
	...
	<div id="header">
       <br>
       <h1 style=" font-family:Agency FB; font-size: 70px; color:#FFFF00;text-shadow: 2px 2px black;"> Citizen Bank of India [CBI] </h1>
       <h2 style=" font-family:Agency FB; font-size: 55px;color:#ee10ee;text-shadow: 2px 2px black;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Basic Banking System </h2>
        ...
        <div id="section">
            <table>
               ...
               <button class="primary_btn" id="button "type="button" href="getdetail.php">Customers</button>
                </a>
			   ...
			   <button class="primary_btn" id="button" type="button">Transactions</button>
               </a>
